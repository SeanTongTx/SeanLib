...
/// </summary>
[CustomPropertyDrawer(typeof(InspectorPlus.ExpandableAttribute), true)]
public class ExpandableDrawer : DefaultPropertyDrawer
{
    ...
    protected override void OnDraw(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if ((this.attribute as InspectorPlus.ExpandableAttribute).SetRuntime)
        {
