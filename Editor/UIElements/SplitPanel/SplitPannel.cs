...
{
    internal class SplitPannel : VisualElement
    {
        //block split-pannel
        const string s_UssClassName = "split-pannel";
        //element 
        const string s_ContentContainerClassName = "split-pannel__content";
        const string s_HandleDragLineClassName = "split-pannel__dragline";
        const string s_HandleDragLineAnchorClassName = "split-pannel__dragline-anchor";
        //modifier
        const string s_VerticalClassName = "split-pannel--vertical";
        const string s_HorizontalClassName = "split-pannel--horizontal";
        const string s_HandleDragLineVerticalClassName = s_HandleDragLineClassName + "--vertical";
        const string s_HandleDragLineHorizontalClassName = s_HandleDragLineClassName + "--horizontal";
        const string s_HandleDragLineAnchorVerticalClassName = s_HandleDragLineAnchorClassName + "--vertical";
        const string s_HandleDragLineAnchorHorizontalClassName = s_HandleDragLineAnchorClassName + "--horizontal";
        ...
        public new class UxmlFactory : UxmlFactory<SplitPannel, UxmlTraits> { }

        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            UxmlIntAttributeDescription m_FixedPaneIndex = new UxmlIntAttributeDescription { name = "index", defaultValue = 0 };
            UxmlIntAttributeDescription m_FixedPaneInitialSize = new UxmlIntAttributeDescription { name = "init-size", defaultValue = 100 };
        ...
        public SplitPannel()
        {
            ...
            styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>(PathTools.RelativeAssetPath(this.GetType(), "../SplitPannel.uss")));
            ...
            m_DragLineAnchor.name = "dragline-anchor";
